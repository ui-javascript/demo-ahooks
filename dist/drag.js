...
var _ahooks = __webpack_require__(/*! ahooks */ "./node_modules/ahooks/es/index.js");
...
var App = () => {
  ...
  var getDragProps = (0, _ahooks.useDrag)({
    onDragStart: data => {
      setDragging(data);
    },
    onDragEnd: () => {
  ...
  var _useDrop = (0, _ahooks.useDrop)({
    onText: (text, e) => {
      console.log(e);
      alert("'text: ".concat(text, "' dropped"));
    },
    onFiles: (files, e) => {
      console.log(e, files);
      alert("".concat(files.length, " file dropped"));
    },
    onUri: (uri, e) => {
      console.log(e);
      alert("uri: ".concat(uri, " dropped"));
    },
    onDom: (content, e) => {
      alert("custom: ".concat(content, " dropped"));
    }
  }),
      _useDrop2 = (0, _slicedToArray2.default)(_useDrop, 2),
      props = _useDrop2[0],
      isHovering = _useDrop2[1].isHovering;

  return _react.default.createElement("div", null, _react.default.createElement("div", Object.assign({
    style: {
      border: '1px dashed #e8e8e8',
      padding: 16,
      textAlign: 'center'
    }
  }, props), isHovering ? 'release here' : 'drop here'), _react.default.createElement("div", {
    style: {
      display: 'flex',
      marginTop: 8
    }
  }, Array.from(Array(5)).map((e, i) => // @ts-ignore
  _react.default.createElement("div", Object.assign({}, getDragProps("box".concat(i)), {
    style: {
  ...
  }), "box", i))), _react.default.createElement("div", {
    style: {
      marginTop: 8
    }
  }, dragging ? _react.default.createElement(_react.default.Fragment, null, "dragging ", dragging) : 'not dragging'));
}; // @ts-ignore


_reactDom.default.render(_react.default.createElement(App, null), mountNode);
...
/*! ModuleConcatenation bailout: Cannot concat with ./node_modules/screenfull/dist/screenfull.js (<- Module is not an ECMAScript module) */
...
var lodash_throttle = __webpack_require__("./node_modules/lodash.throttle/index.js");
var lodash_throttle_default = /*#__PURE__*/__webpack_require__.n(lodash_throttle);

// CONCATENATED MODULE: ./node_modules/@ahooksjs/use-request/es/utils/index.js
...
function usePersistFn(fn) {
  var ref = Object(react["useRef"])(function () {
    throw new Error('Cannot call an event handler while rendering.');
  });
  ref.current = fn;
  var persist = Object(react["useCallback"])(function () {
    var args = [];
...
/* harmony default export */ var utils_usePersistFn = (usePersistFn);
...
function windowFocus_subscribe(listener) {
...
if (typeof window !== 'undefined' && window.addEventListener && !eventsBinded) {
  var windowFocus_revalidate = function revalidate() {
  ...
  window.addEventListener('visibilitychange', windowFocus_revalidate, false);
  window.addEventListener('focus', windowFocus_revalidate, false); // only bind the events once

  eventsBinded = true;
}

/* harmony default export */ var windowFocus = (windowFocus_subscribe);
...
function useAsync(service, options) {
  ...
  var newstFetchKey = Object(react["useRef"])(DEFAULT_KEY); // 持久化一些函数

  var servicePersist = utils_usePersistFn(service);
  var onSuccessPersist = utils_usePersistFn(onSuccess);
  var onErrorPersist = utils_usePersistFn(onError);
  var fetchKeyPersist = utils_usePersistFn(fetchKey);
  var formatResult;
  ...
  var formatResultPersist = utils_usePersistFn(formatResult);
  var config = {
  ...
  var subscribe = utils_usePersistFn(function (key, data) {
  ...
  var _q = useAsync_read(Object(react["useState"])(function () {
    ...
    if (cacheKey) {
      ...
      if (cacheData_1) {
        ...
        Object.keys(cacheData_1.fetches).forEach(function (key) {
          ...
          var newFetch = new useAsync_Fetch(servicePersist, config, subscribe.bind(null, key), {
  ...
  var fetchesRef = Object(react["useRef"])(fetches);
  fetchesRef.current = fetches;
  var readyMemoryParams = Object(react["useRef"])();
  var run = Object(react["useCallback"])(function () {
    var args = [];
    ...
    if (!currentFetch) {
      var newFetch = new useAsync_Fetch(servicePersist, config, subscribe.bind(null, currentFetchKey), {
        data: initialData
      });
  ...
  var runRef = Object(react["useRef"])(run);
  ...
  var hasTriggeredByReady = Object(react["useRef"])(false);
  utils_useUpdateEffect(function () {
    if (ready) {
  ...
  var notExecutedWarning = Object(react["useCallback"])(function (name) {
    return function () {
...
/* harmony default export */ var es_useAsync = (useAsync);
...
function useLoadMore(service, options) {
  ...
  var _c = useLoadMore_read(Object(react["useState"])(false), 2),
      loadingMore = _c[0],
      setLoadingMore = _c[1];
  ...
  var result = es_useAsync(service, useLoadMore_assign(useLoadMore_assign({}, restOptions), {
  ...
  var reload = Object(react["useCallback"])(function () {
    reset();
  ...
  var reloadRef = Object(react["useRef"])(reload);
  ...
  var dataGroup = Object(react["useMemo"])(function () {
  ...
  var scrollMethodRef = Object(react["useRef"])(scrollMethod);
...
/* harmony default export */ var es_useLoadMore = (useLoadMore);
...
function usePaginated(service, options) {
  ...
  var _c = es_useAsync(service, usePaginated_assign({
    defaultParams: [{
      current: 1,
  ...
  var runChangePaination = Object(react["useCallback"])(function (paginationParams) {
  ...
  var totalPage = Object(react["useMemo"])(function () {
    return Math.ceil(total / pageSize);
  }, [pageSize, total]);
  var onChange = Object(react["useCallback"])(function (c, p) {
  ...
  var changeCurrent = Object(react["useCallback"])(function (c) {
    onChange(c, pageSize);
  }, [onChange, pageSize]);
  var changePageSize = Object(react["useCallback"])(function (p) {
    onChange(current, p);
  }, [onChange, current]);
  var changeCurrentRef = Object(react["useRef"])(changeCurrent);
  ...
  var changeTable = Object(react["useCallback"])(function (p, f, s) {
    runChangePaination({
      current: p.current,
...
/* harmony default export */ var es_usePaginated = (usePaginated);
...
/* harmony default export */ var configContext = (ConfigContext);
...
function useRequest(service, options) {
  ...
  var contextConfig = Object(react["useContext"])(configContext);
  ...
  var paginatedRef = Object(react["useRef"])(paginated);
  var loadMoreRef = Object(react["useRef"])(loadMore);
  ...
  if (loadMore) {
    return es_useLoadMore(promiseService, finalOptions);
  }

  if (paginated) {
    return es_usePaginated(promiseService, finalOptions);
  }

  return es_useAsync(promiseService, finalOptions);
}
...
/* harmony default export */ var es = (useRequest);
// CONCATENATED MODULE: ./node_modules/ahooks/es/useUpdateEffect/index.js


var es_useUpdateEffect_useUpdateEffect = function useUpdateEffect(effect, deps) {
  var isMounted = Object(react["useRef"])(false);
  Object(react["useEffect"])(function () {
    if (!isMounted.current) {
      isMounted.current = true;
...
/* harmony default export */ var es_useUpdateEffect = (es_useUpdateEffect_useUpdateEffect);
// CONCATENATED MODULE: ./node_modules/ahooks/es/useControllableValue/index.js
var useControllableValue_read = undefined && undefined.__read || function (o, n) {
  var m = typeof Symbol === "function" && o[Symbol.iterator];
  if (!m) return o;
  var i = m.call(o),
      r,
...
function useControllableValue(props, options) {
  ...
  var _d = useControllableValue_read(Object(react["useState"])(function () {
  ...
  es_useUpdateEffect(function () {
    if (valuePropName in props) {
      setState(value);
    }
  }, [value, valuePropName]);
  var handleSetState = Object(react["useCallback"])(function (v) {
    if (!(valuePropName in props)) {
      setState(v);
    }
...
var useDynamicList_read = undefined && undefined.__read || function (o, n) {
  var m = typeof Symbol === "function" && o[Symbol.iterator];
  if (!m) return o;
  var i = m.call(o),
      r,
...
var useDynamicList_spread = undefined && undefined.__spread || function () {
  for (var ar = [], i = 0; i < arguments.length; i++) {
    ar = ar.concat(useDynamicList_read(arguments[i]));
  }
...
/* harmony default export */ var useDynamicList = (function (initialValue) {
  var counterRef = Object(react["useRef"])(-1); // key 存储器

  var keyList = Object(react["useRef"])([]); // 内部方法

  var setKey = Object(react["useCallback"])(function (index) {
    counterRef.current += 1;
    keyList.current.splice(index, 0, counterRef.current);
  }, []);

  var _a = useDynamicList_read(Object(react["useState"])(function () {
  ...
  var insert = function insert(index, obj) {
    setList(function (l) {
      var temp = useDynamicList_spread(l);
  ...
  var merge = function merge(index, obj) {
    setList(function (l) {
      ...
      temp.splice.apply(temp, useDynamicList_spread([index, 0], obj));
      return temp;
    });
  };
  ...
  var move = function move(oldIndex, newIndex) {
    ...
    setList(function (l) {
      var newList = useDynamicList_spread(l);
...
// CONCATENATED MODULE: ./node_modules/ahooks/es/useEventEmitter/index.js
...
var useEventEmitter_EventEmitter =
/** @class */
function () {
  function EventEmitter() {
    ...
    this.useSubscription = function (callback) {
      var callbackRef = Object(react["useRef"])();
...
function useEventEmitter() {
  ...
  if (!ref.current) {
    ref.current = new useEventEmitter_EventEmitter();
  }
...
// CONCATENATED MODULE: ./node_modules/ahooks/es/utils/dom.js
...
var useSize_read = undefined && undefined.__read || function (o, n) {
  var m = typeof Symbol === "function" && o[Symbol.iterator];
  if (!m) return o;
  var i = m.call(o),
      r,
...
function useSize(target) {
  var _a = useSize_read(Object(react["useState"])(function () {
...
/* harmony default export */ var es_useSize = (useSize);
// CONCATENATED MODULE: ./node_modules/ahooks/es/useVirtualList/index.js
var useVirtualList_read = undefined && undefined.__read || function (o, n) {
  var m = typeof Symbol === "function" && o[Symbol.iterator];
  if (!m) return o;
  var i = m.call(o),
      r,
...
/* harmony default export */ var useVirtualList = (function (list, options) {
  var containerRef = Object(react["useRef"])();
  var size = es_useSize(containerRef); // 暂时禁止 cache
  // const distanceCache = useRef<{ [key: number]: number }>({});

  var _a = useVirtualList_read(Object(react["useState"])({
    start: 0,
    end: 10
  }), 2),
      state = _a[0],
  ...
  var totalHeight = Object(react["useMemo"])(function () {
    if (typeof itemHeight === 'number') {
  ...
  var offsetTop = Object(react["useMemo"])(function () {
...
// CONCATENATED MODULE: ./node_modules/ahooks/es/useResponsive/index.js
var useResponsive_values = undefined && undefined.__values || function (o) {
  var s = typeof Symbol === "function" && Symbol.iterator,
      m = s && o[s],
      i = 0;
  if (m) return m.call(o);
...
var useResponsive_read = undefined && undefined.__read || function (o, n) {
  var m = typeof Symbol === "function" && o[Symbol.iterator];
  if (!m) return o;
  var i = m.call(o),
      r,
...
function useResponsive_init() {
  ...
  window.addEventListener('resize', function () {
    ...
    try {
      for (var subscribers_1 = useResponsive_values(subscribers), subscribers_1_1 = subscribers_1.next(); !subscribers_1_1.done; subscribers_1_1 = subscribers_1.next()) {
...
function calculate() {
  ...
  try {
    for (var _b = useResponsive_values(Object.keys(responsiveConfig)), _c = _b.next(); !_c.done; _c = _b.next()) {
      var key = _c.value;
...
function useResponsive() {
  ...
  var _a = useResponsive_read(Object(react["useState"])(info), 2),
      state = _a[0],
      setState = _a[1];
...
// CONCATENATED MODULE: ./node_modules/ahooks/es/useStorageState/index.js
var useStorageState_read = undefined && undefined.__read || function (o, n) {
  var m = typeof Symbol === "function" && o[Symbol.iterator];
  if (!m) return o;
  var i = m.call(o),
      r,
...
function useStorageState(storage, key, defaultValue) {
  ...
  var _a = useStorageState_read(Object(react["useState"])(function () {
...
/* harmony default export */ var es_useStorageState = (useStorageState);
// CONCATENATED MODULE: ./node_modules/ahooks/es/useLocalStorageState/index.js


function useLocalStorageState(key, defaultValue) {
  return es_useStorageState(function () {
    return localStorage;
  }, key, defaultValue);
}

/* harmony default export */ var es_useLocalStorageState = (useLocalStorageState);
...
// CONCATENATED MODULE: ./node_modules/ahooks/es/useUpdateLayoutEffect/index.js
...
/* harmony default export */ var es_useUpdateLayoutEffect = (useUpdateLayoutEffect_useUpdateLayoutEffect);
// CONCATENATED MODULE: ./node_modules/ahooks/es/useToggle/index.js
var useToggle_read = undefined && undefined.__read || function (o, n) {
  var m = typeof Symbol === "function" && o[Symbol.iterator];
  if (!m) return o;
  var i = m.call(o),
      r,
...
function useToggle(defaultValue, reverseValue) {
  ...
  var _a = useToggle_read(Object(react["useState"])(defaultValue), 2),
      state = _a[0],
      setState = _a[1];

  var actions = Object(react["useMemo"])(function () {
...
/* harmony default export */ var es_useToggle = (useToggle);
// CONCATENATED MODULE: ./node_modules/ahooks/es/useBoolean/index.js
var useBoolean_read = undefined && undefined.__read || function (o, n) {
  var m = typeof Symbol === "function" && o[Symbol.iterator];
  if (!m) return o;
  var i = m.call(o),
      r,
...
function useBoolean(defaultValue) {
  ...
  var _a = useBoolean_read(es_useToggle(defaultValue), 2),
      state = _a[0],
      toggle = _a[1].toggle;
...
// CONCATENATED MODULE: ./node_modules/ahooks/es/useDocumentVisibility/index.js
var useDocumentVisibility_read = undefined && undefined.__read || function (o, n) {
  var m = typeof Symbol === "function" && o[Symbol.iterator];
  if (!m) return o;
  var i = m.call(o),
      r,
...
function useDocumentVisibility() {
  var _a = useDocumentVisibility_read(Object(react["useState"])(function () {
    return getVisibility();
  }), 2),
      documentVisibility = _a[0],
      setDocumentVisibility = _a[1];

  es_useEventListener('visibilitychange', function () {
...
/* harmony default export */ var es_useDocumentVisibility = (useDocumentVisibility);
// CONCATENATED MODULE: ./node_modules/ahooks/es/useSelections/index.js
var useSelections_read = undefined && undefined.__read || function (o, n) {
  var m = typeof Symbol === "function" && o[Symbol.iterator];
  if (!m) return o;
  var i = m.call(o),
      r,
...
function useSelections(items, defaultSelected) {
  ...
  var _a = useSelections_read(Object(react["useState"])(defaultSelected), 2),
      selected = _a[0],
      setSelected = _a[1];

  var _b = Object(react["useMemo"])(function () {
  ...
  var _c = Object(react["useMemo"])(function () {
...
function useCreation(factory, deps) {
  var current = Object(react["useRef"])({
    deps: deps,
    obj: undefined,
    initialized: false
  }).current;
...
function useThrottleFn(fn, options) {
  ...
  var throttled = useCreation(function () {
    return lodash_throttle_default()(function () {
      var args = [];
...
// CONCATENATED MODULE: ./node_modules/ahooks/es/useThrottle/index.js
var useThrottle_read = undefined && undefined.__read || function (o, n) {
  var m = typeof Symbol === "function" && o[Symbol.iterator];
  if (!m) return o;
  var i = m.call(o),
      r,
...
function useThrottle(value, options) {
  var _a = useThrottle_read(Object(react["useState"])(value), 2),
      throttled = _a[0],
      setThrottled = _a[1];

  var run = es_useThrottleFn(function () {
    setThrottled(value);
  }, options).run;
  Object(react["useEffect"])(function () {
    run();
...
/* harmony default export */ var es_useThrottle = (useThrottle);
// CONCATENATED MODULE: ./node_modules/ahooks/es/useThrottleEffect/index.js
var useThrottleEffect_read = undefined && undefined.__read || function (o, n) {
  var m = typeof Symbol === "function" && o[Symbol.iterator];
  if (!m) return o;
  var i = m.call(o),
      r,
...
function useThrottleEffect(effect, deps, options) {
  var _a = useThrottleEffect_read(Object(react["useState"])({}), 2),
      flag = _a[0],
      setFlag = _a[1];
  ...
  es_useUpdateEffect(effect, [flag]);
}

/* harmony default export */ var es_useThrottleEffect = (useThrottleEffect);
// CONCATENATED MODULE: ./node_modules/ahooks/es/useDebounceFn/index.js
var useDebounceFn_read = undefined && undefined.__read || function (o, n) {
  var m = typeof Symbol === "function" && o[Symbol.iterator];
  if (!m) return o;
  var i = m.call(o),
      r,
...
var useDebounceFn_spread = undefined && undefined.__spread || function () {
  for (var ar = [], i = 0; i < arguments.length; i++) {
    ar = ar.concat(useDebounceFn_read(arguments[i]));
  }
...
function useDebounceFn(fn, options) {
  ...
  var debounced = useCreation(function () {
    return lodash_debounce_default()(function () {
      var args = [];
      ...
      return fnRef.current.apply(fnRef, useDebounceFn_spread(args));
    }, wait, options);
  }, []);
  return {
    run: debounced,
...
// CONCATENATED MODULE: ./node_modules/ahooks/es/useDebounce/index.js
var useDebounce_read = undefined && undefined.__read || function (o, n) {
  var m = typeof Symbol === "function" && o[Symbol.iterator];
  if (!m) return o;
  var i = m.call(o),
      r,
...
function useDebounce(value, options) {
  var _a = useDebounce_read(Object(react["useState"])(value), 2),
      debounced = _a[0],
      setDebounced = _a[1];
...
/* harmony default export */ var es_useDebounce = (useDebounce);
// CONCATENATED MODULE: ./node_modules/ahooks/es/usePrevious/index.js

/* harmony default export */ var usePrevious = (function (state, compare) {
  var prevRef = Object(react["useRef"])();
  var curRef = Object(react["useRef"])();
...
var useMouse_read = undefined && undefined.__read || function (o, n) {
  var m = typeof Symbol === "function" && o[Symbol.iterator];
  if (!m) return o;
  var i = m.call(o),
      r,
...
/* harmony default export */ var useMouse = (function () {
  var _a = useMouse_read(Object(react["useState"])(useMouse_initState), 2),
      state = _a[0],
      setState = _a[1];
...
// CONCATENATED MODULE: ./node_modules/ahooks/es/useScroll/index.js
...
function useScroll(target, shouldUpdate) {
  ...
  var _a = useScroll_read(Object(react["useState"])({
    left: NaN,
    top: NaN
  }), 2),
      position = _a[0],
...
/* harmony default export */ var es_useScroll = (useScroll);
...
function useClickAway(onClickAway, target, eventName) {
  ...
  var onClickAwayRef = Object(react["useRef"])(onClickAway);
...
var screenfull = __webpack_require__("./node_modules/screenfull/dist/screenfull.js");
...
var useUnmount_useUnmount = function useUnmount(fn) {
  var fnRef = Object(react["useRef"])(fn);
  fnRef.current = fn;
  Object(react["useEffect"])(function () {
    return function () {
...
/* harmony default export */ var es_useUnmount = (useUnmount_useUnmount);
// CONCATENATED MODULE: ./node_modules/ahooks/es/useFullscreen/index.js
/* eslint no-empty: 0 */
var useFullscreen_read = undefined && undefined.__read || function (o, n) {
  var m = typeof Symbol === "function" && o[Symbol.iterator];
  if (!m) return o;
  var i = m.call(o),
      r,
...
/* harmony default export */ var useFullscreen = (function (target, options) {
  var _a = options || {},
      onExitFull = _a.onExitFull,
      onFull = _a.onFull;

  var onExitFullRef = Object(react["useRef"])(onExitFull);
  onExitFullRef.current = onExitFull;
  var onFullRef = Object(react["useRef"])(onFull);
  onFullRef.current = onFull;

  var _b = useFullscreen_read(Object(react["useState"])(false), 2),
      state = _b[0],
      setState = _b[1];

  var onChange = Object(react["useCallback"])(function () {
    if (screenfull_default.a.isEnabled) {
      var isFullscreen = screenfull_default.a.isFullscreen;
  ...
  var setFull = Object(react["useCallback"])(function () {
    var el = getTargetElement(target);
    ...
    if (screenfull_default.a.isEnabled) {
      try {
        screenfull_default.a.request(el);
        screenfull_default.a.on('change', onChange);
      } catch (error) {}
    }
  }, [target, onChange]);
  var exitFull = Object(react["useCallback"])(function () {
    if (!state) {
      return;
    }
  ...
  var toggleFull = Object(react["useCallback"])(function () {
    if (state) {
      exitFull();
    } else {
      setFull();
...
var useInViewport_read = undefined && undefined.__read || function (o, n) {
  var m = typeof Symbol === "function" && o[Symbol.iterator];
  if (!m) return o;
  var i = m.call(o),
      r,
...
var useInViewport_values = undefined && undefined.__values || function (o) {
  var s = typeof Symbol === "function" && Symbol.iterator,
      m = s && o[s],
      i = 0;
  if (m) return m.call(o);
...
function useInViewport(target) {
  var _a = useInViewport_read(Object(react["useState"])(function () {
    var el = getTargetElement(target);
  ...
  Object(react["useEffect"])(function () {
    ...
    var observer = new IntersectionObserver(function (entries) {
      ...
      try {
        for (var entries_1 = useInViewport_values(entries), entries_1_1 = entries_1.next(); !entries_1_1.done; entries_1_1 = entries_1.next()) {
...
// CONCATENATED MODULE: ./node_modules/ahooks/es/useKeyPress/index.js
var useKeyPress_values = undefined && undefined.__values || function (o) {
  var s = typeof Symbol === "function" && Symbol.iterator,
      m = s && o[s],
      i = 0;
  if (m) return m.call(o);
...
function genFilterKey(event, keyFilter) {
  ...
  try {
    for (var genArr_1 = useKeyPress_values(genArr), genArr_1_1 = genArr_1.next(); !genArr_1_1.done; genArr_1_1 = genArr_1.next()) {
...
function useKeyPress(keyFilter, eventHandler, option) {
  ...
  var callbackRef = Object(react["useRef"])(eventHandler);
  ...
  Object(react["useEffect"])(function () {
    ...
    try {
      for (var events_1 = useKeyPress_values(events), events_1_1 = events_1.next(); !events_1_1.done; events_1_1 = events_1.next()) {
    ...
    return function () {
      ...
      try {
        for (var events_2 = useKeyPress_values(events), events_2_1 = events_2.next(); !events_2_1.done; events_2_1 = events_2.next()) {
...
/* harmony default export */ var es_useKeyPress = (useKeyPress);
// CONCATENATED MODULE: ./node_modules/ahooks/es/useHover/index.js
var useHover_read = undefined && undefined.__read || function (o, n) {
  var m = typeof Symbol === "function" && o[Symbol.iterator];
  if (!m) return o;
  var i = m.call(o),
      r,
...
/* harmony default export */ var useHover = (function (target, options) {
  var _a = options || {},
      onEnter = _a.onEnter,
      onLeave = _a.onLeave;

  var _b = useHover_read(useBoolean(false), 2),
      state = _b[0],
      _c = _b[1],
      setTrue = _c.setTrue,
      setFalse = _c.setFalse;

  es_useEventListener('mouseenter', function () {
    onEnter && onEnter();
    setTrue();
  }, {
    target: target
  });
  es_useEventListener('mouseleave', function () {
    onLeave && onLeave();
    setFalse();
  }, {
    target: target
...
var es_usePersistFn_read = undefined && undefined.__read || function (o, n) {
  var m = typeof Symbol === "function" && o[Symbol.iterator];
  if (!m) return o;
  var i = m.call(o),
      r,
...
var es_usePersistFn_spread = undefined && undefined.__spread || function () {
  for (var ar = [], i = 0; i < arguments.length; i++) {
    ar = ar.concat(es_usePersistFn_read(arguments[i]));
  }
...
function usePersistFn_usePersistFn(fn) {
  ...
  ref.current = fn;
  var persistFn = Object(react["useCallback"])(function () {
    var args = [];
    ...
    return ref.current.apply(ref, es_usePersistFn_spread(args));
  }, [ref]);
  return persistFn;
}

/* harmony default export */ var es_usePersistFn = (usePersistFn_usePersistFn);
// CONCATENATED MODULE: ./node_modules/ahooks/es/useAntdTable/index.js
var useAntdTable_assign = undefined && undefined.__assign || function () {
  useAntdTable_assign = Object.assign || function (t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
      s = arguments[i];
  ...
  return useAntdTable_assign.apply(this, arguments);
};

var useAntdTable_rest = undefined && undefined.__rest || function (s, e) {
  var t = {};
...
var useAntdTable_read = undefined && undefined.__read || function (o, n) {
  var m = typeof Symbol === "function" && o[Symbol.iterator];
  if (!m) return o;
  var i = m.call(o),
      r,
...
var useAntdTable_spread = undefined && undefined.__spread || function () {
  for (var ar = [], i = 0; i < arguments.length; i++) {
    ar = ar.concat(useAntdTable_read(arguments[i]));
  }
...
function useAntdTable(service, options) {
  var form = options.form,
      ...
      restOptions = useAntdTable_rest(options, ["form", "refreshDeps", "manual", "defaultType", "defaultParams"]);

  var result = es(service, useAntdTable_assign(useAntdTable_assign({}, restOptions), {
    paginated: true,
    manual: true
  }));
  ...
  var _c = useAntdTable_read(Object(react["useState"])(cacheFormTableData.type || defaultType), 2),
      type = _c[0],
      setType = _c[1]; // 全量 form 数据，包括 simple 和 advance


  var _d = useAntdTable_read(Object(react["useState"])(cacheFormTableData.allFormData || defaultParams && defaultParams[1] || {}), 2),
      allFormData = _d[0],
      setAllFormData = _d[1]; // 获取当前展示的 form 字段值


  var getActivetFieldValues = Object(react["useCallback"])(function () {
    if (!form) {
      return {};
    } // antd 3
  ...
  var formRef = Object(react["useRef"])(form);
  ...
  Object(react["useEffect"])(function () {
    // 如果有缓存，则使用缓存，重新请求
    if (params.length > 0) {
      run.apply(void 0, useAntdTable_spread(params));
      return;
    } // 如果没有缓存，触发 submit
  ...
  var changeType = Object(react["useCallback"])(function () {
    var currentFormData = getActivetFieldValues();
    setAllFormData(useAntdTable_assign(useAntdTable_assign({}, allFormData), currentFormData));
    var targetType = type === 'simple' ? 'advance' : 'simple';
    setType(targetType);
  }, [type, allFormData, getActivetFieldValues]);
  var validateFields = Object(react["useCallback"])(function () {
  ...
  var _submit = Object(react["useCallback"])(function (initParams) {
    setTimeout(function () {
      validateFields().then(function () {
        var activeFormData = getActivetFieldValues(); // 记录全量数据

        var _allFormData = useAntdTable_assign(useAntdTable_assign({}, allFormData), activeFormData);
        ...
        run(useAntdTable_assign(useAntdTable_assign({
  ...
  var resetPersistFn = es_usePersistFn(reset); // refreshDeps 变化，reset。

  es_useUpdateEffect(function () {
    if (!manual) {
      resetPersistFn();
    }
  }, useAntdTable_spread(refreshDeps));
  var submit = es_usePersistFn(function (e) {
  ...
  return useAntdTable_assign(useAntdTable_assign({}, result), {
    search: {
      submit: submit,
      type: type,
...
/* harmony default export */ var es_useAntdTable = (useAntdTable);
// CONCATENATED MODULE: ./node_modules/ahooks/es/useFusionTable/fusionAdapter.js
var fusionAdapter_assign = undefined && undefined.__assign || function () {
  fusionAdapter_assign = Object.assign || function (t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
      s = arguments[i];
  ...
  return fusionAdapter_assign.apply(this, arguments);
};
...
var resultAdapter = function resultAdapter(result) {
  ...
  return fusionAdapter_assign(fusionAdapter_assign({}, result), {
    tableProps: tableProps,
    paginationProps: paginationProps
  });
};
// CONCATENATED MODULE: ./node_modules/ahooks/es/useFusionTable/index.js
var useFusionTable_assign = undefined && undefined.__assign || function () {
  useFusionTable_assign = Object.assign || function (t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
      s = arguments[i];
  ...
  return useFusionTable_assign.apply(this, arguments);
};
...
function useFusionTable(service, options) {
  var ret = es_useAntdTable(service, useFusionTable_assign(useFusionTable_assign({}, options), {
    form: options.field ? fieldAdapter(options.field) : undefined
  }));
  return resultAdapter(ret);
}

/* harmony default export */ var es_useFusionTable = (useFusionTable);
// CONCATENATED MODULE: ./node_modules/ahooks/es/useSet/index.js
var useSet_assign = undefined && undefined.__assign || function () {
  useSet_assign = Object.assign || function (t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
      s = arguments[i];
  ...
  return useSet_assign.apply(this, arguments);
};

var useSet_read = undefined && undefined.__read || function (o, n) {
  var m = typeof Symbol === "function" && o[Symbol.iterator];
  if (!m) return o;
  var i = m.call(o),
      r,
...
var useSet_spread = undefined && undefined.__spread || function () {
  for (var ar = [], i = 0; i < arguments.length; i++) {
    ar = ar.concat(useSet_read(arguments[i]));
  }
...
function useSet(initialValue) {
  var initialSet = Object(react["useMemo"])(function () {
    return initialValue === undefined ? new Set() : new Set(initialValue);
  }, [initialValue]);

  var _a = useSet_read(Object(react["useState"])(initialSet), 2),
      set = _a[0],
      setSet = _a[1];

  var stableActions = Object(react["useMemo"])(function () {
    return {
      add: function add(key) {
        return setSet(function (prevSet) {
          return new Set(useSet_spread(Array.from(prevSet), [key]));
        });
      },
  ...
  var utils = useSet_assign({
    has: Object(react["useCallback"])(function (key) {
      return set.has(key);
    }, [set])
  }, stableActions);
...
/* harmony default export */ var es_useSet = (useSet);
// CONCATENATED MODULE: ./node_modules/ahooks/es/useMap/index.js
...
var useMap_read = undefined && undefined.__read || function (o, n) {
  var m = typeof Symbol === "function" && o[Symbol.iterator];
  if (!m) return o;
  var i = m.call(o),
      r,
...
function useMap(initialValue) {
  var initialMap = Object(react["useMemo"])(function () {
    return initialValue === undefined ? new Map() : new Map(initialValue);
  }, [initialValue]);

  var _a = useMap_read(Object(react["useState"])(initialMap), 2),
      map = _a[0],
      _set = _a[1];
  ...
  var utils = useMap_assign({
    get: Object(react["useCallback"])(function (key) {
      return map.get(key);
    }, [map])
  }, stableActions);
...
/* harmony default export */ var es_useMap = (useMap);
// CONCATENATED MODULE: ./node_modules/ahooks/es/useDrop/useDrag.js
...
/* harmony default export */ var useDrop_useDrag = (useDrag);
// CONCATENATED MODULE: ./node_modules/ahooks/es/useDrop/useDrop.js
var useDrop_read = undefined && undefined.__read || function (o, n) {
  var m = typeof Symbol === "function" && o[Symbol.iterator];
  if (!m) return o;
  var i = m.call(o),
      r,
...
var useDrop_useDrop = function useDrop(options) {
  if (options === void 0) {
    options = {};
  }
  ...
  var _a = useDrop_read(Object(react["useState"])(false), 2),
      isHovering = _a[0],
      setIsHovering = _a[1];

  var callback = Object(react["useCallback"])(function (dataTransfer, event) {
...
/* harmony default export */ var es_useDrop_useDrop = (useDrop_useDrop);
...
var useMount_useMount = function useMount(fn) {
  // 持久化函数
  var fnPersist = es_usePersistFn(fn);
  Object(react["useEffect"])(function () {
...
/* harmony default export */ var es_useMount = (useMount_useMount);
// CONCATENATED MODULE: ./node_modules/ahooks/es/useTextSelection/index.js
var useTextSelection_assign = undefined && undefined.__assign || function () {
  useTextSelection_assign = Object.assign || function (t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
      s = arguments[i];
  ...
  return useTextSelection_assign.apply(this, arguments);
};

var useTextSelection_read = undefined && undefined.__read || function (o, n) {
  var m = typeof Symbol === "function" && o[Symbol.iterator];
  if (!m) return o;
  var i = m.call(o),
      r,
...
var useTextSelection_initState = useTextSelection_assign({
  text: ''
}, initRect);
...
function useTextSelection(target) {
  var _a = useTextSelection_read(Object(react["useState"])(useTextSelection_initState), 2),
      state = _a[0],
      setState = _a[1];

  var stateRef = Object(react["useRef"])(state);
  ...
  Object(react["useEffect"])(function () {
    ...
    var mouseupHandler = function mouseupHandler() {
      ...
      if (text) {
        ...
        setState(useTextSelection_assign(useTextSelection_assign(useTextSelection_assign({}, state), {
          text: text
        }), rect));
      }
    }; // 任意点击都需要清空之前的 range
    ...
    var mousedownHandler = function mousedownHandler() {
      ...
      if (stateRef.current.text) {
        setState(useTextSelection_assign({}, useTextSelection_initState));
      }
...
/* harmony default export */ var es_useTextSelection = (useTextSelection);
// CONCATENATED MODULE: ./node_modules/ahooks/es/useCounter/index.js
var useCounter_read = undefined && undefined.__read || function (o, n) {
  var m = typeof Symbol === "function" && o[Symbol.iterator];
  if (!m) return o;
  var i = m.call(o),
      r,
...
function useCounter(initialValue, options) {
  ...
  var _a = useCounter_read(Object(react["useState"])(init), 2),
      current = _a[0],
      setCurrent = _a[1];
...
/* harmony default export */ var es_useCounter = (useCounter);
...
var useUpdate_useUpdate = function useUpdate() {
  var _a = useUpdate_read(Object(react["useState"])(0), 2),
      setState = _a[1];
...
/* harmony default export */ var es_useUpdate = (useUpdate_useUpdate);
// CONCATENATED MODULE: ./node_modules/ahooks/es/useEventTarget/index.js
var useEventTarget_read = undefined && undefined.__read || function (o, n) {
  var m = typeof Symbol === "function" && o[Symbol.iterator];
  if (!m) return o;
  var i = m.call(o),
      r,
...
function useEventTarget(options) {
  ...
  var _b = useEventTarget_read(Object(react["useState"])(initialValue), 2),
      value = _b[0],
      setValue = _b[1];
  ...
  var transformerRef = Object(react["useRef"])(transformer);
  transformerRef.current = transformer;
  var onChange = Object(react["useCallback"])(function (e) {
...
/* harmony default export */ var es_useEventTarget = (useEventTarget);
// CONCATENATED MODULE: ./node_modules/ahooks/es/useHistoryTravel/index.js
var useHistoryTravel_read = undefined && undefined.__read || function (o, n) {
  var m = typeof Symbol === "function" && o[Symbol.iterator];
  if (!m) return o;
  var i = m.call(o),
      r,
...
var useHistoryTravel_spread = undefined && undefined.__spread || function () {
  for (var ar = [], i = 0; i < arguments.length; i++) {
    ar = ar.concat(useHistoryTravel_read(arguments[i]));
  }
...
function useHistoryTravel(initialValue) {
  var _a = useHistoryTravel_read(Object(react["useState"])({
  ...
  var updateValue = Object(react["useCallback"])(function (val) {
    setHistory({
      present: val,
      future: [],
      past: useHistoryTravel_spread(past, [present])
    });
  }, [history, setHistory]);

  var _forward = Object(react["useCallback"])(function (step) {
    if (step === void 0) {
      step = 1;
    }
    ...
    setHistory({
      past: useHistoryTravel_spread(past, [present], _before),
      present: _current,
      future: _after
    });
  }, [history, setHistory]);

  var _backward = Object(react["useCallback"])(function (step) {
    if (step === void 0) {
      step = -1;
    }
    ...
    setHistory({
      past: _before,
      present: _current,
      future: useHistoryTravel_spread(_after, [present], future)
    });
  }, [history, setHistory]);

  var go = Object(react["useCallback"])(function (step) {
  ...
  return {
    ...
    go: go,
    back: Object(react["useCallback"])(function () {
      go(-1);
    }, [go]),
    forward: Object(react["useCallback"])(function () {
      go(1);
    }, [go]),
    reset: reset
  };
...
var useDebounceEffect_read = undefined && undefined.__read || function (o, n) {
  var m = typeof Symbol === "function" && o[Symbol.iterator];
  if (!m) return o;
  var i = m.call(o),
      r,
...
function useDebounceEffect(effect, deps, options) {
  var _a = useDebounceEffect_read(Object(react["useState"])({}), 2),
      flag = _a[0],
      setFlag = _a[1];
...
// CONCATENATED MODULE: ./node_modules/ahooks/es/useCookieState/index.js
var useCookieState_assign = undefined && undefined.__assign || function () {
  useCookieState_assign = Object.assign || function (t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
      s = arguments[i];
  ...
  return useCookieState_assign.apply(this, arguments);
};

var useCookieState_rest = undefined && undefined.__rest || function (s, e) {
  var t = {};
...
var useCookieState_read = undefined && undefined.__read || function (o, n) {
  var m = typeof Symbol === "function" && o[Symbol.iterator];
  if (!m) return o;
  var i = m.call(o),
      r,
...
function useCookieState(cookieKey, options) {
  ...
  var _a = useCookieState_read(Object(react["useState"])(function () {
    var cookieValue = js_cookie_default.a.get(cookieKey);
    if (typeof cookieValue === 'string') return cookieValue;
    if (utils_isFunction(options.defaultValue)) return options.defaultValue();
  ...
  var updateState = Object(react["useCallback"])(function (newValue, newOptions) {
    if (newOptions === void 0) {
      newOptions = {};
    }

    var _a = useCookieState_assign(useCookieState_assign({}, options), newOptions),
        defaultValue = _a.defaultValue,
        restOptions = useCookieState_rest(_a, ["defaultValue"]);

    setState(function (prevState) {
      var value = utils_isFunction(newValue) ? newValue(prevState) : newValue;

      if (value === undefined || value === null) {
        js_cookie_default.a.remove(cookieKey);
      } else {
        js_cookie_default.a.set(cookieKey, value, restOptions);
      }
...
/* harmony default export */ var es_useCookieState = (useCookieState);
// CONCATENATED MODULE: ./node_modules/ahooks/es/useSetState/index.js
var useSetState_read = undefined && undefined.__read || function (o, n) {
  var m = typeof Symbol === "function" && o[Symbol.iterator];
  if (!m) return o;
  var i = m.call(o),
      r,
...
var useSetState_useSetState = function useSetState(initialState) {
  if (initialState === void 0) {
    initialState = {};
  }

  var _a = useSetState_read(Object(react["useState"])(initialState), 2),
      state = _a[0],
      setState = _a[1];

  var setMergeState = Object(react["useCallback"])(function (patch) {
    setState(function (prevState) {
...
/* harmony default export */ var es_useSetState = (useSetState_useSetState);
// CONCATENATED MODULE: ./node_modules/ahooks/es/useInterval/index.js


function useInterval(fn, delay, options) {
  var immediate = options === null || options === void 0 ? void 0 : options.immediate;
  var fnRef = Object(react["useRef"])();
  fnRef.current = fn;
  Object(react["useEffect"])(function () {
    var _a;
...
/* harmony default export */ var es_useInterval = (useInterval);
// CONCATENATED MODULE: ./node_modules/ahooks/es/useWhyDidYouUpdate/index.js
var useWhyDidYouUpdate_assign = undefined && undefined.__assign || function () {
  useWhyDidYouUpdate_assign = Object.assign || function (t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
      s = arguments[i];
  ...
  return useWhyDidYouUpdate_assign.apply(this, arguments);
};
...
function useWhyDidYouUpdate(componentName, props) {
  ...
  Object(react["useEffect"])(function () {
    if (prevProps.current) {
      var allKeys = Object.keys(useWhyDidYouUpdate_assign(useWhyDidYouUpdate_assign({}, prevProps.current), props));
      var changedProps_1 = {};
...
// CONCATENATED MODULE: ./node_modules/ahooks/es/useTitle/index.js
...
function useTitle(title, options) {
  ...
  var titleRef = Object(react["useRef"])(document.title);
  Object(react["useEffect"])(function () {
...
/* harmony default export */ var es_useTitle = (typeof document !== 'undefined' ? useTitle : function (_title) {});
// CONCATENATED MODULE: ./node_modules/ahooks/es/useNetwork/index.js
...
var useNetwork_read = undefined && undefined.__read || function (o, n) {
  var m = typeof Symbol === "function" && o[Symbol.iterator];
  if (!m) return o;
  var i = m.call(o),
      r,
...
function useNetwork() {
  var _a = useNetwork_read(Object(react["useState"])(function () {
    return useNetwork_assign({
      since: undefined,
  ...
  Object(react["useEffect"])(function () {
    var onOnline = function onOnline() {
      setState(function (prevState) {
        return useNetwork_assign(useNetwork_assign({}, prevState), {
          online: true,
          since: new Date()
        });
      });
    ...
    var onConnectionChange = function onConnectionChange() {
      setState(function (prevState) {
        return useNetwork_assign(useNetwork_assign({}, prevState), getConnectionProperty());
      });
    };
...
/* harmony default export */ var es_useNetwork = (useNetwork);
...
// CONCATENATED MODULE: ./node_modules/ahooks/es/useReactive/index.js
var useReactive_read = undefined && undefined.__read || function (o, n) {
  var m = typeof Symbol === "function" && o[Symbol.iterator];
  if (!m) return o;
  var i = m.call(o),
      r,
...
function useReactive_observer(initialVal, cb) {
  return new Proxy(initialVal, {
    get: function get(target, key, receiver) {
      var res = Reflect.get(target, key, receiver);
      return typeof res === 'object' ? useReactive_observer(res, cb) : Reflect.get(target, key);
    },
...
function useReactive(initialState) {
  var _a = useReactive_read(Object(react["useState"])({}), 2),
      setFlag = _a[1];

  var stateRef = Object(react["useRef"])(initialState);
  var state = useCreation(function () {
    return useReactive_observer(stateRef.current, function () {
      setFlag({});
    });
  }, []);
  return state;
...
/* harmony default export */ var es_useReactive = (useReactive);
// CONCATENATED MODULE: ./node_modules/ahooks/es/useFavicon/index.js
...
var useFavicon_useFavicon = function useFavicon(favUrl) {
  Object(react["useEffect"])(function () {
    if (!favUrl) return;
...
/* harmony default export */ var es_useFavicon = (useFavicon_useFavicon);
// EXTERNAL MODULE: ./node_modules/dayjs/dayjs.min.js
var dayjs_min = __webpack_require__("./node_modules/dayjs/dayjs.min.js");
var dayjs_min_default = /*#__PURE__*/__webpack_require__.n(dayjs_min);

// CONCATENATED MODULE: ./node_modules/ahooks/es/useCountDown/index.js
var useCountDown_read = undefined && undefined.__read || function (o, n) {
  var m = typeof Symbol === "function" && o[Symbol.iterator];
  if (!m) return o;
  var i = m.call(o),
      r,
...
var useCountDown_calcLeft = function calcLeft(t) {
  if (!t) {
    return 0;
  } // https://stackoverflow.com/questions/4310953/invalid-date-in-safari


  var left = dayjs_min_default()(t).valueOf() - new Date().getTime();
...
var useCountDown_useCountdown = function useCountdown(options) {
  var _a = options || {},
      targetDate = _a.targetDate,
      _b = _a.interval,
      interval = _b === void 0 ? 1000 : _b;

  var _c = useCountDown_read(Object(react["useState"])(targetDate), 2),
      target = _c[0],
      setTargetDate = _c[1];

  var _d = useCountDown_read(Object(react["useState"])(function () {
    return useCountDown_calcLeft(target);
  }), 2),
      timeLeft = _d[0],
      setTimeLeft = _d[1];
  ...
  Object(react["useEffect"])(function () {
    ...
    setTimeLeft(useCountDown_calcLeft(target));
    var timer = setInterval(function () {
      var targetLeft = useCountDown_calcLeft(target);
  ...
  var formattedRes = Object(react["useMemo"])(function () {
    return parseMs(timeLeft);
  }, [timeLeft]);
  return [timeLeft, setTargetDate, formattedRes];
};

/* harmony default export */ var useCountDown = (useCountDown_useCountdown);
// CONCATENATED MODULE: ./node_modules/ahooks/es/useWebSocket/index.js
var useWebSocket_read = undefined && undefined.__read || function (o, n) {
  var m = typeof Symbol === "function" && o[Symbol.iterator];
  if (!m) return o;
  var i = m.call(o),
      r,
...
function useWebSocket(socketUrl, options) {
  ...
  var reconnectTimesRef = Object(react["useRef"])(0);
  var reconnectTimerRef = Object(react["useRef"])();
  var websocketRef = Object(react["useRef"])();

  var _c = useWebSocket_read(Object(react["useState"])(), 2),
      latestMessage = _c[0],
      setLatestMessage = _c[1];

  var _d = useWebSocket_read(Object(react["useState"])(ReadyState.Closed), 2),
      readyState = _d[0],
      setReadyState = _d[1];
  /**
   * 重连
  ...
  var reconnect = es_usePersistFn(function () {
    var _a;
  ...
  var connectWs = es_usePersistFn(function () {
    reconnectTimerRef.current && clearTimeout(reconnectTimerRef.current);
  ...
  var sendMessage = es_usePersistFn(function (message) {
    var _a;
  ...
  var connect = es_usePersistFn(function () {
    reconnectTimesRef.current = 0;
    connectWs();
  });
  /**
  ...
  var disconnect = es_usePersistFn(function () {
    var _a;
...
// CONCATENATED MODULE: ./node_modules/ahooks/es/index.js
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "useControlledValue", function() { return es_useControlledValue; });
/* concated harmony reexport useControllableValue */__webpack_require__.d(__webpack_exports__, "useControllableValue", function() { return useControllableValue; });
/* concated harmony reexport useDynamicList */__webpack_require__.d(__webpack_exports__, "useDynamicList", function() { return useDynamicList; });
/* concated harmony reexport useVirtualList */__webpack_require__.d(__webpack_exports__, "useVirtualList", function() { return useVirtualList; });
/* concated harmony reexport useResponsive */__webpack_require__.d(__webpack_exports__, "useResponsive", function() { return useResponsive; });
/* concated harmony reexport useEventEmitter */__webpack_require__.d(__webpack_exports__, "useEventEmitter", function() { return useEventEmitter; });
/* concated harmony reexport useLocalStorageState */__webpack_require__.d(__webpack_exports__, "useLocalStorageState", function() { return es_useLocalStorageState; });
/* concated harmony reexport useSessionStorageState */__webpack_require__.d(__webpack_exports__, "useSessionStorageState", function() { return es_useSessionStorageState; });
/* concated harmony reexport useSize */__webpack_require__.d(__webpack_exports__, "useSize", function() { return es_useSize; });
/* concated harmony reexport configResponsive */__webpack_require__.d(__webpack_exports__, "configResponsive", function() { return configResponsive; });
/* concated harmony reexport useUpdateEffect */__webpack_require__.d(__webpack_exports__, "useUpdateEffect", function() { return es_useUpdateEffect; });
/* concated harmony reexport useUpdateLayoutEffect */__webpack_require__.d(__webpack_exports__, "useUpdateLayoutEffect", function() { return es_useUpdateLayoutEffect; });
/* concated harmony reexport useBoolean */__webpack_require__.d(__webpack_exports__, "useBoolean", function() { return useBoolean; });
/* concated harmony reexport useToggle */__webpack_require__.d(__webpack_exports__, "useToggle", function() { return es_useToggle; });
/* concated harmony reexport useDocumentVisibility */__webpack_require__.d(__webpack_exports__, "useDocumentVisibility", function() { return es_useDocumentVisibility; });
/* concated harmony reexport useSelections */__webpack_require__.d(__webpack_exports__, "useSelections", function() { return useSelections; });
/* concated harmony reexport useThrottle */__webpack_require__.d(__webpack_exports__, "useThrottle", function() { return es_useThrottle; });
/* concated harmony reexport useThrottleFn */__webpack_require__.d(__webpack_exports__, "useThrottleFn", function() { return es_useThrottleFn; });
/* concated harmony reexport useThrottleEffect */__webpack_require__.d(__webpack_exports__, "useThrottleEffect", function() { return es_useThrottleEffect; });
/* concated harmony reexport useDebounce */__webpack_require__.d(__webpack_exports__, "useDebounce", function() { return es_useDebounce; });
/* concated harmony reexport useDebounceFn */__webpack_require__.d(__webpack_exports__, "useDebounceFn", function() { return es_useDebounceFn; });
/* concated harmony reexport useDebounceEffect */__webpack_require__.d(__webpack_exports__, "useDebounceEffect", function() { return es_useDebounceEffect; });
/* concated harmony reexport usePrevious */__webpack_require__.d(__webpack_exports__, "usePrevious", function() { return usePrevious; });
/* concated harmony reexport useMouse */__webpack_require__.d(__webpack_exports__, "useMouse", function() { return useMouse; });
/* concated harmony reexport useScroll */__webpack_require__.d(__webpack_exports__, "useScroll", function() { return es_useScroll; });
/* concated harmony reexport useClickAway */__webpack_require__.d(__webpack_exports__, "useClickAway", function() { return useClickAway; });
/* concated harmony reexport useFullscreen */__webpack_require__.d(__webpack_exports__, "useFullscreen", function() { return useFullscreen; });
/* concated harmony reexport useInViewport */__webpack_require__.d(__webpack_exports__, "useInViewport", function() { return es_useInViewport; });
/* concated harmony reexport useKeyPress */__webpack_require__.d(__webpack_exports__, "useKeyPress", function() { return es_useKeyPress; });
/* concated harmony reexport useEventListener */__webpack_require__.d(__webpack_exports__, "useEventListener", function() { return es_useEventListener; });
/* concated harmony reexport useHover */__webpack_require__.d(__webpack_exports__, "useHover", function() { return useHover; });
/* concated harmony reexport useRequest */__webpack_require__.d(__webpack_exports__, "useRequest", function() { return es; });
/* concated harmony reexport UseRequestProvider */__webpack_require__.d(__webpack_exports__, "UseRequestProvider", function() { return UseRequestProvider; });
/* concated harmony reexport useAntdTable */__webpack_require__.d(__webpack_exports__, "useAntdTable", function() { return es_useAntdTable; });
/* concated harmony reexport useUnmount */__webpack_require__.d(__webpack_exports__, "useUnmount", function() { return es_useUnmount; });
/* concated harmony reexport useSet */__webpack_require__.d(__webpack_exports__, "useSet", function() { return es_useSet; });
/* concated harmony reexport usePersistFn */__webpack_require__.d(__webpack_exports__, "usePersistFn", function() { return es_usePersistFn; });
/* concated harmony reexport useMap */__webpack_require__.d(__webpack_exports__, "useMap", function() { return es_useMap; });
/* concated harmony reexport useCreation */__webpack_require__.d(__webpack_exports__, "useCreation", function() { return useCreation; });
/* concated harmony reexport useDrag */__webpack_require__.d(__webpack_exports__, "useDrag", function() { return useDrop_useDrag; });
/* concated harmony reexport useDrop */__webpack_require__.d(__webpack_exports__, "useDrop", function() { return es_useDrop_useDrop; });
/* concated harmony reexport useMount */__webpack_require__.d(__webpack_exports__, "useMount", function() { return es_useMount; });
/* concated harmony reexport useCounter */__webpack_require__.d(__webpack_exports__, "useCounter", function() { return es_useCounter; });
/* concated harmony reexport useUpdate */__webpack_require__.d(__webpack_exports__, "useUpdate", function() { return es_useUpdate; });
/* concated harmony reexport useTextSelection */__webpack_require__.d(__webpack_exports__, "useTextSelection", function() { return es_useTextSelection; });
/* concated harmony reexport useEventTarget */__webpack_require__.d(__webpack_exports__, "useEventTarget", function() { return es_useEventTarget; });
/* concated harmony reexport useHistoryTravel */__webpack_require__.d(__webpack_exports__, "useHistoryTravel", function() { return useHistoryTravel; });
/* concated harmony reexport useFusionTable */__webpack_require__.d(__webpack_exports__, "useFusionTable", function() { return es_useFusionTable; });
/* concated harmony reexport useCookieState */__webpack_require__.d(__webpack_exports__, "useCookieState", function() { return es_useCookieState; });
/* concated harmony reexport useSetState */__webpack_require__.d(__webpack_exports__, "useSetState", function() { return es_useSetState; });
/* concated harmony reexport useInterval */__webpack_require__.d(__webpack_exports__, "useInterval", function() { return es_useInterval; });
/* concated harmony reexport useWhyDidYouUpdate */__webpack_require__.d(__webpack_exports__, "useWhyDidYouUpdate", function() { return useWhyDidYouUpdate; });
/* concated harmony reexport useTitle */__webpack_require__.d(__webpack_exports__, "useTitle", function() { return es_useTitle; });
/* concated harmony reexport useNetwork */__webpack_require__.d(__webpack_exports__, "useNetwork", function() { return es_useNetwork; });
/* concated harmony reexport useTimeout */__webpack_require__.d(__webpack_exports__, "useTimeout", function() { return es_useTimeout; });
/* concated harmony reexport useReactive */__webpack_require__.d(__webpack_exports__, "useReactive", function() { return es_useReactive; });
/* concated harmony reexport useFavicon */__webpack_require__.d(__webpack_exports__, "useFavicon", function() { return es_useFavicon; });
/* concated harmony reexport useCountDown */__webpack_require__.d(__webpack_exports__, "useCountDown", function() { return useCountDown; });
/* concated harmony reexport useWebSocket */__webpack_require__.d(__webpack_exports__, "useWebSocket", function() { return useWebSocket; });
var ahooks_es_read = undefined && undefined.__read || function (o, n) {
  var m = typeof Symbol === "function" && o[Symbol.iterator];
  if (!m) return o;
  var i = m.call(o),
      r,
...
var ahooks_es_spread = undefined && undefined.__spread || function () {
  for (var ar = [], i = 0; i < arguments.length; i++) {
    ar = ar.concat(ahooks_es_read(arguments[i]));
  }
...
var es_useControlledValue = function useControlledValue() {
  var args = [];
  ...
  return useControllableValue.apply(void 0, ahooks_es_spread(args));
};
...
/***/ "./node_modules/umi-plugin-mpa/templates/polyfill.js":
/*!***********************************************************!*\
  !*** ./node_modules/umi-plugin-mpa/templates/polyfill.js ***!
  \***********************************************************/
/*! no static exports found */
...
/***/ 0:
/*!***************************************************************************************!*\
  !*** multi ./node_modules/umi-plugin-mpa/templates/polyfill.js ./_ahooks-ui/drag.tsx ***!
  \***************************************************************************************/
/*! no static exports found */
/*! all exports used */
/*! ModuleConcatenation bailout: Module is not an ECMAScript module */
...
__webpack_require__(/*! E:\workspace-natural\natural-demo-ahooks\node_modules\umi-plugin-mpa\templates\polyfill.js */"./node_modules/umi-plugin-mpa/templates/polyfill.js");
module.exports = __webpack_require__(/*! ./_ahooks-ui/drag.tsx */"./_ahooks-ui/drag.tsx");
